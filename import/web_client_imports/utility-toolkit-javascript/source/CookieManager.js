...
*/
define(["./Helpers","./Environment"], function(Helpers,Environment){  
 ...
 */
  ...
  var CookieManager = {
    ...
    checkCookiesFunctionality: function() {
      ...
      //serve per pararsi da una eventuale concorrenza con altre pagine
      var rand = Helpers.randomG(); 
      
      //mi disinteresso del test di qui sopra, faccio un test di
      //funzionalità
